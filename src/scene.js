...
// Adicione isso antes de renderizar a cena
const ambientLight = new THREE.AmbientLight(0xffffff, 0.5); // Luz suave global
scene.add(ambientLight);

// Opcional: Uma luz direcional para dar volume
...
scene.add(dirLight);
  ...
  const mat = new THREE.MeshStandardMaterial({
  color: 0x000000,             // Mude para preto se quiser que só o brilho apareça
  emissive: 0x223388,
  emissiveIntensity: 2.0,      // Aumente para > 1.0 para brilho intenso
  toneMapped: false            // Impede que o Three.js corte o brilho excessivo
});
